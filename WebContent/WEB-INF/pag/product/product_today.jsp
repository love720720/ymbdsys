...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/page/product-today.js"></script>
...
<body>
<div class="alert alert-info">当前位置<b class="tip"></b>商品管理<b class="tip"></b>今日商品列表</div>
<form>
